parcelRequire = (function (e, r, t, n) {
...
})(
  {
      ...
      function (require, module, exports) {
        module.exports = {
          ...
          scripts: {
            test: "jest",
            "format-dist":
              "sed -i '' 's/\"files\":/\"_files\":/' dist/package.json",
          ...
          bugs: { url: "https://github.com/gnosis/safe-apps-sdk/issues" },
        ...
        (exports.MessageFormatter = r),
          (r.makeRequest = (r, t) => {
            return {
              ...
              method: r,
              params: t,
              env: { sdkVersion: s.getSDKVersion() },
            };
          }),
    ...
    zQsh: [
            ...
            (this.allowedOrigins = null),
              ...
              (this.isValidMessage = ({ origin: e, data: s, source: t }) => {
                const i = !s,
                  ...
                  o =
                    (void 0 !== s.version &&
                      parseInt(s.version.split(".")[0])) >= 1;
                let r = !0;
                return (
                  Array.isArray(this.allowedOrigins) &&
                    (r = void 0 !== this.allowedOrigins.find((s) => s.test(e))),
                  !i && n && o && r
                );
              }),
      ...
      { "./messageFormatter": "lESK", "./methods": "csOC" },
    ],
    VZwL: [
      function (require, module, exports) {
        "use strict";
        ...
        class e {
          ...
          async getBySafeTxHash(t) {
            ...
            const e = new AbortController(),
              r = { method: "GET", signal: e.signal };
            setTimeout(() => e.abort(), 1e4);
            try {
              const e = await fetch(
                `${this.txServiceUrl}/transactions/${t}`,
                r
              );
              if (200 !== e.status)
                throw new Error(
    ...
    L7Ea: [
      function (require, module, exports) {
        ...
        const t = require("../eth/constants"),
          ...
          a = {
            ...
            blockNumberToHex: (t) =>
              Number.isInteger(t) ? `0x${t.toString(16)}` : t,
          };
        class l {
          constructor(e) {
            (this.communicator = e),
      ...
      { "../eth/constants": "lAWO", "../communication/methods": "csOC" },
    ],
    ThoU: [
      function (require, module, exports) {
        "use strict";
        ...
        class n {
          constructor(t = {}) {
            if ("undefined" == typeof window)
              throw new Error(
                "Error initializing the sdk: window is undefined"
              );
          ...
          async getEnvInfo() {
            const t = await this.communicator.send(
              e.METHODS.getEnvInfo,
              void 0
            );
      ...
      { "./communication": "zQsh", "./txs": "VZwL", "./eth": "L7Ea" },
    ],
    ppnA: [
      function (require, module, exports) {
        "use strict";
