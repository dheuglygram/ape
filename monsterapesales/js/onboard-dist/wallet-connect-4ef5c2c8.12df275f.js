    ...
    b1xZ: [
      function (require, module, exports) {
        ...
        function c(n) {
          ...
          if (!(c || (o && o[d])))
            throw new Error(
              'A "infuraKey" or a "rpc" object with a parameter of '.concat(
                d,
                " must be included in the WalletConnect initialization object"
              )
            );
          return {
                        ...
                        case 0:
                          return (
                            ...
                            require("_bundle_loader")(
                              require.resolve("./providerEngine-7945c13d.js")
                            )
                          );
                        case 2:
                          return (
                            ...
                            (e.next = 5),
                            require("_bundle_loader")(
                              require.resolve("@walletconnect/web3-provider")
                            )
                          );
                        case 5:
                          if (
      ...
      },
      {
        ...
        "./providerEngine-7945c13d.js": [
          ["providerEngine-7945c13d.01157afe.js", "ihoK"],
          "ihoK",
        ],
