      ...
      function (require, module, exports) {
                      ...
                      case 0:
                        return (
                          ...
                          require("_bundle_loader")(
                            require.resolve("@gnosis.pm/safe-apps-sdk")
                          )
                        );
                      case 3:
                        return (
        ...
        function c(e) {
          var t = e.preferred,
            ...
            f = e.appName
              ? "Then go to APPS and select <b>".concat(e.appName, "</b>.")
              : e.appUrl
              ? "Then go to APPS and add a custom app with the URL:<br /><b>".concat(
                  e.appUrl,
                  "</b>"
                )
              : "";
                  ...
                  return regeneratorRuntime.wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (n = t.createModernProviderInterface),
                            (e.next = 3),
                            require("_bundle_loader")(
                              require.resolve("@gnosis.pm/safe-apps-sdk")
                            )
                        ...
                        case 3:
                          return (
                            ...
                            (e.next = 7),
                            require("_bundle_loader")(
                              require.resolve("@gnosis.pm/safe-apps-provider")
                            )
                          );
                        case 7:
                          return (
